...
RSpec.describe AnimalsController, type: :controller do
  ...
  describe "GET #index" do
    ...
    it "assigns all animals as @animals" do
      ...
      get :index, { facility_id: animal.facility_id }, valid_session
  ...
  describe "GET #show" do
    ...
    it "assigns the requested animal as @animal" do
      animal = create(:animal)
      get :show, {id: animal.id, facility_id: animal.facility_id}, valid_session
  ...
  describe "GET #new" do
    ...
    it "assigns a new animal as @animal" do
      ...
      get :new, {facility_id: facility.id}, valid_session
  ...
  describe "GET #edit" do
    ...
    it "assigns the requested animal as @animal" do
      animal = create(:animal)
      get :edit, {id: animal.id, facility_id: animal.facility_id}, valid_session
      expect(assigns(:animal)).to eq(animal)
    end
  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      it "creates a new Animal" do
        facility = create(:facility)
        expect {
          post :create, {facility_id: facility.id, :animal => valid_animal.attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved animal as @animal" do
        facility = create(:facility)
        post :create, {facility_id: facility.id, :animal => invalid_animal.attributes}, valid_session
        expect(assigns(:animal)).to be_a_new(Animal)
      end
  ...
  describe "PUT #update" do
    ...
    context "with valid params" do
      ...
      it "updates the requested animal" do
        animal = create(:animal)
        put :update, {facility_id: animal.facility.id, :id => animal.id, :animal => new_attributes}, valid_session
        animal.reload
    ...
    context "with invalid params" do
      ...
      it "assigns the animal as @animal" do
        animal = create(:animal)
        put :update, {facility_id: animal.facility.id, :id => animal.id, :animal => bad_attributes}, valid_session
        expect(assigns(:animal)).to eq(animal)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "destroys the requested animal" do
      animal = create(:animal)
      expect {
        delete :destroy, {facility_id: animal.facility_id, :id => animal.to_param}, valid_session
      }.to change(Animal, :count).by(-1)
    end
