...
RSpec.describe AnimalsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #index' do
      expect(get: '/facilities/1/animals').
        to route_to('animals#index', facility_id: '1')
    end

    it 'routes to #new' do
      expect(get: '/facilities/1/animals/new').
        to route_to('animals#new', facility_id: '1')
    end
    ...
    it 'routes to #create' do
      expect(post: '/facilities/1/animals').
        to route_to('animals#create', facility_id: '1')
    end
